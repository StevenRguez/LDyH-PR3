...
/**
 * @class TOPTWSolution
 * @brief Clase que representa una solución para el problema TOPTW (Team Orienteering Problem with Time Windows).
 * */
public class TOPTWSolution {
    ...
    /**
     * Constructor que inicializa una solución para el problema dado.
     * Inicializa los arrays de predecesores, sucesores, tiempos de espera, posición en ruta, y rutas.
     *
     * @param problem La instancia del problema TOPTW a resolver.
     */
    ...
    /**
     * Inicializa la solución configurando el depósito y estableciendo los valores predeterminados.
     * Este método reinicia los arrays de predecesores, sucesores y rutas.
     */
     ...
     * @return `true` si las soluciones son equivalentes, `false` en caso contrario.
     */
     ...
     *
     * @param x Índice del primer punto.
     * @param y Índice del segundo punto.
     * @return La distancia entre `x` y `y`.
     */
     ...
     *
     * @param availableVehicles Número de vehículos disponibles a establecer.
     */
     ...
     *
     * @return Cadena de texto con la información detallada de la solución.
     */
     ...
     *
     * @return El valor calculado de la función objetivo.
     */
    ...
    /**
     * Añade una nueva ruta a la solución, decrementa el contador de vehículos disponibles y
     * ajusta los arrays de predecesores y sucesores.
     *
     * @return El índice del nuevo depósito en la ruta añadida.
     */
    public int addRoute() {
    ...
    /**
     * Imprime una representación en consola de la solución actual.
     * Incluye los nodos visitados en cada ruta y el valor de la función objetivo.
     *
     * @return Valor de la función objetivo después de imprimir la solución.
     */
